...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var i, s = _gsScope.document, a = s.defaultView ? s.defaultView.getComputedStyle : function () {
    }, h = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
    f = -1 !== ((_gsScope.navigator || {}).userAgent || "").indexOf("Edge"), g = "codepen", u = "DrawSVGPlugin",
  ...
  i = _gsScope._gsDefine.plugin({
    ...
    init: function (e, t, i, s) {
      ...
      if (!l) return window.location.href = "http://" + d + c + "?plugin=" + u + "&source=" + g, !1;
      var h, C, p, m, S = r(e) + 1;
