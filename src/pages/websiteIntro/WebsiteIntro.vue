<template>
  <div>
    <img class="topImg" src="../../assets/websiteIntro/pic_top.jpg" alt="">
    <div class="desc">
    ...
    <img src="../../assets/websiteIntro/pic_1.jpg" alt="">
    <div class="desc">
    ...
    <div class="desc">
      <div class="descFirstLine verticalLine">
        <p>从</p>
        <p>开</p>
        <p>始</p>
        <p>,</p>
      ...
      <p>我们拥有经验丰富的婚礼统筹团队，时刻在你左右提供建议与帮助，让你和你的家人可以轻松的享受每个珍贵难忘的时刻，</p>
